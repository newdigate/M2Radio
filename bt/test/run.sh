...
for t in bondtable_test l2cap_test avdtp_test sdp_test avrcp_test btlink_test a2dpsource_test a2dpsink_test btsession_test btsinksession_test sbc_test sbcdecoder_test rtp_test mediapacketizer_test; do
