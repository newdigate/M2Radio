...
CXX=${CXX:-c++}
for t in bondtable_test l2cap_test avdtp_test sdp_test avrcp_test btlink_test a2dpsource_test btsession_test sbc_test rtp_test mediapacketizer_test; do
